          ...
          <div className="mx-auto mt-16 max-w-5xl">
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <FeatureCard
                ...
                title="Communities"
                description="Create and join communities around any topic. Moderate, grow, and manage your own spaces."
                icon={
                  <svg
                    aria-hidden="true"
                    className="h-6 w-6"
              ...
              <FeatureCard
                ...
                description="Engage in rich, nested conversations. Reply to comments and keep discussions organized."
                icon={
                  <svg
                    aria-hidden="true"
                    className="h-6 w-6"
              ...
              <FeatureCard
                ...
                title="Voting System"
                description="Upvote great content to surface the best discussions. Help the community highlight quality posts."
                icon={
                  <svg
                    aria-hidden="true"
                    className="h-6 w-6"
              ...
              <FeatureCard
                ...
                title="Modern UI"
                description="Clean, responsive design built with Tailwind CSS v4 and shadcn/ui components."
                icon={
                  <svg
                    aria-hidden="true"
                    className="h-6 w-6"
              ...
              <FeatureCard
                ...
                description="Server-side rendering, static generation, and optimized performance out of the box."
                icon={
                  <svg
                    aria-hidden="true"
                    className="h-6 w-6"
              ...
              <FeatureCard
                ...
                description="Built with security best practices, authentication, and data protection in mind."
                icon={
                  <svg
                    aria-hidden="true"
                    className="h-6 w-6"
